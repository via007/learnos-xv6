    ...
    33a5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test finished\n");
    ...
    355e:	68 74 4d 00 00       	push   $0x4d74
    3563:	6a 01                	push   $0x1
    3565:	e8 06 05 00 00       	call   3a70 <printf>
}
...
00003660 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3660:	69 05 6c 5e 00 00 0d 	imul   $0x19660d,0x5e6c,%eax
    3667:	66 19 00 
    366a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    366f:	a3 6c 5e 00 00       	mov    %eax,0x5e6c
}
    3674:	c3                   	ret    
    ...
    39b6:	89 d3                	mov    %edx,%ebx
{
  ...
  if(neg)
    ...
    3a27:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  write(fd, &c, 1);
    ...
    3a3e:	56                   	push   %esi
    3a3f:	57                   	push   %edi
    3a40:	e8 ac fe ff ff       	call   38f1 <write>
  ...
  neg = 0;
    ...
    3a64:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3a6b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    3a6f:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3ab9:	e8 33 fe ff ff       	call   38f1 <write>
  ...
  write(fd, &c, 1);
    ...
    3b1a:	e8 d2 fd ff ff       	call   38f1 <write>
        putc(fd, c);
      } else {
  ...
  write(fd, &c, 1);
    ...
    3b2e:	e8 be fd ff ff       	call   38f1 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    3ba4:	e8 48 fd ff ff       	call   38f1 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    3c1b:	57                   	push   %edi
    3c1c:	53                   	push   %ebx
    3c1d:	e8 cf fc ff ff       	call   38f1 <write>
        while(*s != 0){
    ...
    3c41:	a1 20 5f 00 00       	mov    0x5f20,%eax
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    3c57:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
malloc(uint nbytes)
{
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3cfa:	73 72                	jae    3d6e <malloc+0x9e>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3d3b:	e8 19 fc ff ff       	call   3959 <sbrk>
  if(p == (char*)-1)
