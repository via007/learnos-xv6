...
int main()
{
   ...
   e:	83 ec 04             	sub    $0x4,%esp
    printf(1,"The result is : %d\n",printingMyFavoriteYear());
  11:	e8 0b 03 00 00       	call   321 <printingMyFavoriteYear>
 ...
 366:	89 d3                	mov    %edx,%ebx
{
 ...
 3ee:	56                   	push   %esi
 3ef:	57                   	push   %edi
 3f0:	e8 ac fe ff ff       	call   2a1 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 4ca:	e8 d2 fd ff ff       	call   2a1 <write>
        putc(fd, c);
      } else {
 ...
 4de:	e8 be fd ff ff       	call   2a1 <write>
  for(i = 0; fmt[i]; i++){
 ...
 551:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 554:	e8 48 fd ff ff       	call   2a1 <write>
        ap++;
 ...
 5cb:	57                   	push   %edi
 5cc:	53                   	push   %ebx
 5cd:	e8 cf fc ff ff       	call   2a1 <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 6eb:	e8 19 fc ff ff       	call   309 <sbrk>
  if(p == (char*)-1)
