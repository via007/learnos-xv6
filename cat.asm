...
printf(int fd, const char *fmt, ...)
{
 ...
 549:	e8 33 fe ff ff       	call   381 <write>
 ...
 5aa:	e8 d2 fd ff ff       	call   381 <write>
        putc(fd, c);
      } else {
 ...
 5be:	e8 be fd ff ff       	call   381 <write>
  for(i = 0; fmt[i]; i++){
 ...
 631:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 634:	e8 48 fd ff ff       	call   381 <write>
        ap++;
 ...
 6ab:	57                   	push   %edi
 6ac:	53                   	push   %ebx
 6ad:	e8 cf fc ff ff       	call   381 <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 769:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 76c:	8b 3d a0 0b 00 00    	mov    0xba0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7cb:	e8 19 fc ff ff       	call   3e9 <sbrk>
  if(p == (char*)-1)
 ...
 7e2:	e8 e9 fe ff ff       	call   6d0 <free>
  return freep;
 7e7:	8b 15 a0 0b 00 00    	mov    0xba0,%edx
