...
00000060 <fmtname>:
{
  ...
  return buf;
  cb:	bb 28 0e 00 00       	mov    $0xe28,%ebx
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
  ...
  e1:	05 28 0e 00 00       	add    $0xe28,%eax
  e6:	52                   	push   %edx
  e7:	6a 20                	push   $0x20
  e9:	50                   	push   %eax
...
00000110 <ls>:
{
 ...
 2b1:	50                   	push   %eax
 2b2:	68 d0 0a 00 00       	push   $0xad0
 2b7:	6a 01                	push   $0x1
 2b9:	e8 82 04 00 00       	call   740 <printf>
 ...
 2f3:	68 dd 0a 00 00       	push   $0xadd
 2f8:	6a 01                	push   $0x1
 2fa:	e8 41 04 00 00       	call   740 <printf>
      break;
 ...
 313:	57                   	push   %edi
 314:	68 bc 0a 00 00       	push   $0xabc
 319:	6a 02                	push   $0x2
 31b:	e8 20 04 00 00       	call   740 <printf>
    close(fd);
 ...
 33b:	57                   	push   %edi
 33c:	68 bc 0a 00 00       	push   $0xabc
 341:	6a 01                	push   $0x1
 343:	e8 f8 03 00 00       	call   740 <printf>
        continue;
...
printf(int fd, const char *fmt, ...)
{
 ...
 789:	e8 33 fe ff ff       	call   5c1 <write>
 ...
 7ea:	e8 d2 fd ff ff       	call   5c1 <write>
        putc(fd, c);
      } else {
 ...
 7fe:	e8 be fd ff ff       	call   5c1 <write>
  for(i = 0; fmt[i]; i++){
 ...
 871:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 874:	e8 48 fd ff ff       	call   5c1 <write>
        ap++;
 ...
 8eb:	57                   	push   %edi
 8ec:	53                   	push   %ebx
 8ed:	e8 cf fc ff ff       	call   5c1 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 911:	a1 38 0e 00 00       	mov    0xe38,%eax
{
 ...
 936:	73 10                	jae    948 <free+0x38>
{
 ...
 961:	5b                   	pop    %ebx
  freep = p;
 962:	a3 38 0e 00 00       	mov    %eax,0xe38
}
 967:	5e                   	pop    %esi
 968:	5f                   	pop    %edi
 969:	5d                   	pop    %ebp
 ...
 987:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 98a:	a3 38 0e 00 00       	mov    %eax,0xe38
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9ac:	8b 3d 38 0e 00 00    	mov    0xe38,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9f9:	8b 3d 38 0e 00 00    	mov    0xe38,%edi
 ...
 a0b:	e8 19 fc ff ff       	call   629 <sbrk>
  if(p == (char*)-1)
 ...
 a22:	e8 e9 fe ff ff       	call   910 <free>
  return freep;
 a27:	8b 15 38 0e 00 00    	mov    0xe38,%edx
 ...
 a54:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a57:	89 15 38 0e 00 00    	mov    %edx,0xe38
}
 ...
 a6f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 a70:	c7 05 38 0e 00 00 3c 	movl   $0xe3c,0xe38
 a77:	0e 00 00 
    base.s.size = 0;
 a7a:	bf 3c 0e 00 00       	mov    $0xe3c,%edi
    base.s.ptr = freep = prevp = &base;
 a7f:	c7 05 3c 0e 00 00 3c 	movl   $0xe3c,0xe3c
 a86:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
