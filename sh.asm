...
fork1(void)
{
  ...
  exit();
      ...
      9d:	68 20 19 00 00       	push   $0x1920
      a2:	e8 b9 0a 00 00       	call   b60 <strlen>
      if(chdir(buf+3) < 0)
      a7:	c7 04 24 23 19 00 00 	movl   $0x1923,(%esp)
      buf[strlen(buf)-1] = 0;  // chop \n
      ae:	c6 80 1f 19 00 00 00 	movb   $0x0,0x191f(%eax)
      if(chdir(buf+3) < 0)
      ...
      c1:	50                   	push   %eax
      c2:	68 23 19 00 00       	push   $0x1923
      c7:	68 e1 12 00 00       	push   $0x12e1
      cc:	6a 02                	push   $0x2
      ce:	e8 fd 0d 00 00       	call   ed0 <printf>
...
00000110 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     11e:	68 38 12 00 00       	push   $0x1238
     123:	6a 02                	push   $0x2
...
00000160 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     169:	68 d5 12 00 00       	push   $0x12d5
     16e:	6a 02                	push   $0x2
...
00000180 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     199:	ff 24 85 f0 12 00 00 	jmp    *0x12f0(,%eax,4)
    if(pipe(p) < 0)
  ...
  if(pid == -1)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     23a:	68 42 12 00 00       	push   $0x1242
     23f:	6a 02                	push   $0x2
     241:	e8 8a 0c 00 00       	call   ed0 <printf>
    break;
  ...
  if(pid == -1)
    ...
    panic("runcmd");
     ...
     29a:	68 3b 12 00 00       	push   $0x123b
     29f:	e8 bc fe ff ff       	call   160 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     2a4:	52                   	push   %edx
     2a5:	ff 73 08             	pushl  0x8(%ebx)
     2a8:	68 52 12 00 00       	push   $0x1252
     2ad:	6a 02                	push   $0x2
     2af:	e8 1c 0c 00 00       	call   ed0 <printf>
      exit();
     2b4:	e8 78 0a 00 00       	call   d31 <exit>
      panic("pipe");
     2b9:	83 ec 0c             	sub    $0xc,%esp
     2bc:	68 67 12 00 00       	push   $0x1267
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     357:	6a 54                	push   $0x54
     359:	e8 d2 0d 00 00       	call   1130 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     417:	6a 0c                	push   $0xc
     419:	e8 12 0d 00 00       	call   1130 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     457:	6a 08                	push   $0x8
     459:	e8 d2 0c 00 00       	call   1130 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     489:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ad:	50                   	push   %eax
     4ae:	68 00 19 00 00       	push   $0x1900
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4fd:	50                   	push   %eax
     4fe:	68 00 19 00 00       	push   $0x1900
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     546:	50                   	push   %eax
     547:	68 f8 18 00 00       	push   $0x18f8
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     565:	50                   	push   %eax
     566:	68 00 19 00 00       	push   $0x1900
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     60d:	50                   	push   %eax
     60e:	68 00 19 00 00       	push   $0x1900
...
00000820 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     839:	68 a8 12 00 00       	push   $0x12a8
  cmd = parseexec(ps, es);
...
00000930 <parseblock>:
{
  ...
  if(!peek(ps, es, ")"))
     ...
     969:	68 c8 12 00 00       	push   $0x12c8
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9d5:	ff 24 85 08 13 00 00 	jmp    *0x1308(,%eax,4)
...
00000a70 <parsecmd>:
{
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     ac6:	6a 02                	push   $0x2
     ac8:	e8 03 04 00 00       	call   ed0 <printf>
    panic("syntax");
     ...
     e16:	89 d3                	mov    %edx,%ebx
{
     ...
     e1b:	89 45 bc             	mov    %eax,-0x44(%ebp)
  if(sgn && xx < 0){
     e1e:	85 d2                	test   %edx,%edx
     e20:	0f 89 92 00 00 00    	jns    eb8 <printint+0xa8>
     e26:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
     e2a:	0f 84 88 00 00 00    	je     eb8 <printint+0xa8>
    neg = 1;
     e30:	c7 45 c0 01 00 00 00 	movl   $0x1,-0x40(%ebp)
    x = -xx;
     e37:	f7 db                	neg    %ebx
  } else {
    x = xx;
  ...
  i = 0;
     e39:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
     e40:	8d 75 d7             	lea    -0x29(%ebp),%esi
     e43:	eb 08                	jmp    e4d <printint+0x3d>
     e45:	8d 76 00             	lea    0x0(%esi),%esi
  do{
    buf[i++] = digits[x % base];
     e48:	89 7d c4             	mov    %edi,-0x3c(%ebp)
  }while((x /= base) != 0);
     e4b:	89 c3                	mov    %eax,%ebx
    buf[i++] = digits[x % base];
     e4d:	89 d8                	mov    %ebx,%eax
     e4f:	31 d2                	xor    %edx,%edx
     e51:	8b 7d c4             	mov    -0x3c(%ebp),%edi
     e54:	f7 f1                	div    %ecx
     e56:	83 c7 01             	add    $0x1,%edi
     e59:	0f b6 92 28 13 00 00 	movzbl 0x1328(%edx),%edx
     e60:	88 14 3e             	mov    %dl,(%esi,%edi,1)
  }while((x /= base) != 0);
     e63:	39 d9                	cmp    %ebx,%ecx
     e65:	76 e1                	jbe    e48 <printint+0x38>
  if(neg)
     e67:	8b 45 c0             	mov    -0x40(%ebp),%eax
     e6a:	85 c0                	test   %eax,%eax
     e6c:	74 0d                	je     e7b <printint+0x6b>
    buf[i++] = '-';
     e6e:	c6 44 3d d8 2d       	movb   $0x2d,-0x28(%ebp,%edi,1)
     e73:	ba 2d 00 00 00       	mov    $0x2d,%edx
    buf[i++] = digits[x % base];
     e78:	89 7d c4             	mov    %edi,-0x3c(%ebp)
     e7b:	8b 45 c4             	mov    -0x3c(%ebp),%eax
     e7e:	8b 7d bc             	mov    -0x44(%ebp),%edi
     e81:	8d 5c 05 d7          	lea    -0x29(%ebp,%eax,1),%ebx
     e85:	eb 0f                	jmp    e96 <printint+0x86>
  ...
  while(--i >= 0)
     ...
     eaa:	75 e4                	jne    e90 <printint+0x80>
    putc(fd, buf[i]);
}
  ...
  neg = 0;
     eb8:	c7 45 c0 00 00 00 00 	movl   $0x0,-0x40(%ebp)
     ebf:	e9 75 ff ff ff       	jmp    e39 <printint+0x29>
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
     ...
     f19:	e8 33 fe ff ff       	call   d51 <write>
  ...
  for(i = 0; fmt[i]; i++){
     f27:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
     f2b:	84 db                	test   %bl,%bl
     f2d:	74 71                	je     fa0 <printf+0xd0>
    c = fmt[i] & 0xff;
     f2f:	0f be cb             	movsbl %bl,%ecx
     f32:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
     f35:	85 d2                	test   %edx,%edx
     f37:	74 c7                	je     f00 <printf+0x30>
      }
    } else if(state == '%'){
     f39:	83 fa 25             	cmp    $0x25,%edx
     f3c:	75 e6                	jne    f24 <printf+0x54>
      if(c == 'd'){
     f3e:	83 f8 64             	cmp    $0x64,%eax
     f41:	0f 84 99 00 00 00    	je     fe0 <printf+0x110>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
     f47:	81 e1 f7 00 00 00    	and    $0xf7,%ecx
     f4d:	83 f9 70             	cmp    $0x70,%ecx
     f50:	74 5e                	je     fb0 <printf+0xe0>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
     f52:	83 f8 73             	cmp    $0x73,%eax
     f55:	0f 84 d5 00 00 00    	je     1030 <printf+0x160>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
     ...
     f5b:	83 f8 63             	cmp    $0x63,%eax
     f5e:	0f 84 8c 00 00 00    	je     ff0 <printf+0x120>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
     f64:	83 f8 25             	cmp    $0x25,%eax
     f67:	0f 84 b3 00 00 00    	je     1020 <printf+0x150>
  write(fd, &c, 1);
     f6d:	83 ec 04             	sub    $0x4,%esp
     f70:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
     f74:	6a 01                	push   $0x1
     f76:	57                   	push   %edi
     f77:	ff 75 08             	pushl  0x8(%ebp)
     f7a:	e8 d2 fd ff ff       	call   d51 <write>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
     f7f:	88 5d e7             	mov    %bl,-0x19(%ebp)
  write(fd, &c, 1);
     f82:	83 c4 0c             	add    $0xc,%esp
     f85:	6a 01                	push   $0x1
     f87:	83 c6 01             	add    $0x1,%esi
     f8a:	57                   	push   %edi
     f8b:	ff 75 08             	pushl  0x8(%ebp)
     f8e:	e8 be fd ff ff       	call   d51 <write>
  for(i = 0; fmt[i]; i++){
     f93:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
        putc(fd, c);
     f97:	83 c4 10             	add    $0x10,%esp
      }
      state = 0;
     f9a:	31 d2                	xor    %edx,%edx
  for(i = 0; fmt[i]; i++){
     f9c:	84 db                	test   %bl,%bl
     f9e:	75 8f                	jne    f2f <printf+0x5f>
    }
  }
}
     fa0:	8d 65 f4             	lea    -0xc(%ebp),%esp
     fa3:	5b                   	pop    %ebx
     fa4:	5e                   	pop    %esi
     fa5:	5f                   	pop    %edi
     fa6:	5d                   	pop    %ebp
     ...
     fc2:	e8 49 fe ff ff       	call   e10 <printint>
        ap++;
  ...
  write(fd, &c, 1);
    1004:	e8 48 fd ff ff       	call   d51 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    1026:	e9 5a ff ff ff       	jmp    f85 <printf+0xb5>
    ...
    1054:	eb 1a                	jmp    1070 <printf+0x1a0>
          s = "(null)";
    1056:	bb 20 13 00 00       	mov    $0x1320,%ebx
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    107b:	57                   	push   %edi
    107c:	53                   	push   %ebx
    107d:	e8 cf fc ff ff       	call   d51 <write>
        while(*s != 0){
    ...
    10a1:	a1 84 19 00 00       	mov    0x1984,%eax
{
    ...
    10ae:	8b 10                	mov    (%eax),%edx
  bp = (Header*)ap - 1;
    10b0:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    10b3:	39 c8                	cmp    %ecx,%eax
    10b5:	73 19                	jae    10d0 <free+0x30>
    ...
    10c6:	73 10                	jae    10d8 <free+0x38>
{
  ...
  freep = p;
    ...
    10f1:	5b                   	pop    %ebx
  freep = p;
    10f2:	a3 84 19 00 00       	mov    %eax,0x1984
}
    10f7:	5e                   	pop    %esi
    10f8:	5f                   	pop    %edi
    10f9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    113c:	8b 3d 84 19 00 00    	mov    0x1984,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1142:	8d 70 07             	lea    0x7(%eax),%esi
    1145:	c1 ee 03             	shr    $0x3,%esi
    1148:	83 c6 01             	add    $0x1,%esi
  if((prevp = freep) == 0){
    114b:	85 ff                	test   %edi,%edi
    114d:	0f 84 ad 00 00 00    	je     1200 <malloc+0xd0>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1153:	8b 17                	mov    (%edi),%edx
    if(p->s.size >= nunits){
    1155:	8b 4a 04             	mov    0x4(%edx),%ecx
    1158:	39 f1                	cmp    %esi,%ecx
    115a:	73 72                	jae    11ce <malloc+0x9e>
    115c:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
    1162:	bb 00 10 00 00       	mov    $0x1000,%ebx
    1167:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
    116a:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    1171:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    1174:	eb 1b                	jmp    1191 <malloc+0x61>
    1176:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    117d:	8d 76 00             	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1180:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    1182:	8b 48 04             	mov    0x4(%eax),%ecx
    1185:	39 f1                	cmp    %esi,%ecx
    1187:	73 4f                	jae    11d8 <malloc+0xa8>
    1189:	8b 3d 84 19 00 00    	mov    0x1984,%edi
  ...
  return freep;
    11b7:	8b 15 84 19 00 00    	mov    0x1984,%edx
      if((p = morecore(nunits)) == 0)
    11bd:	83 c4 10             	add    $0x10,%esp
    11c0:	85 d2                	test   %edx,%edx
    11c2:	75 bc                	jne    1180 <malloc+0x50>
        return 0;
  }
}
    11c4:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return 0;
    ...
    11e1:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    11e4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    11e7:	89 15 84 19 00 00    	mov    %edx,0x1984
}
    ...
    11ff:	90                   	nop
    base.s.ptr = freep = prevp = &base;
    1200:	c7 05 84 19 00 00 88 	movl   $0x1988,0x1984
    1207:	19 00 00 
    base.s.size = 0;
    120a:	bf 88 19 00 00       	mov    $0x1988,%edi
    base.s.ptr = freep = prevp = &base;
    120f:	c7 05 88 19 00 00 88 	movl   $0x1988,0x1988
    1216:	19 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1219:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    121b:	c7 05 8c 19 00 00 00 	movl   $0x0,0x198c
    1222:	00 00 00 
    if(p->s.size >= nunits){
    1225:	e9 32 ff ff ff       	jmp    115c <malloc+0x2c>
