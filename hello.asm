...
int main(int argc, char *argv[]){
  ...
  20:	6a 09                	push   $0x9
  22:	68 af 07 00 00       	push   $0x7af
  27:	6a 01                	push   $0x1
  29:	e8 12 04 00 00       	call   440 <printf>

	exit();
  2e:	e8 6e 02 00 00       	call   2a1 <exit>
  33:	66 90                	xchg   %ax,%ax
  35:	66 90                	xchg   %ax,%ax
  37:	66 90                	xchg   %ax,%ax
  39:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 4ea:	e8 d2 fd ff ff       	call   2c1 <write>
        putc(fd, c);
      } else {
 ...
 4fe:	e8 be fd ff ff       	call   2c1 <write>
  for(i = 0; fmt[i]; i++){
 ...
 571:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 574:	e8 48 fd ff ff       	call   2c1 <write>
        ap++;
 ...
 5c4:	eb 1a                	jmp    5e0 <printf+0x1a0>
          s = "(null)";
 5c6:	bb b3 07 00 00       	mov    $0x7b3,%ebx
        while(*s != 0){
 ...
 5eb:	57                   	push   %edi
 5ec:	53                   	push   %ebx
 5ed:	e8 cf fc ff ff       	call   2c1 <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 70b:	e8 19 fc ff ff       	call   329 <sbrk>
  if(p == (char*)-1)
